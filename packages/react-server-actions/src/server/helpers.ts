...
import type {
  ...
  IdleActionResult,
  InvalidActionResult,
  InvalidActionResultWithoutFormData,
  SuccessActionResult,
...
export const success = (data: any) =>
  ({
    success: true,
    data,
  }) satisfies SuccessActionResultWithoutFormData;
...
export const invalid = <Schema extends z.ZodType<any>>(
  ...
  ({
    success: false,
    invalid,
  }) satisfies InvalidActionResultWithoutFormData<Schema>;
...
export const error = (error: unknown) =>
  ...
  }) satisfies ErrorActionResultWithoutFormData;

// ** Private helpers
export function _actionSuccess<Schema extends z.ZodType<any>>(
  formData: z.infer<Schema>,
  actionResult: SuccessActionResultWithoutFormData,
) {
  return {
    ...actionResult,
...
export function _actionError<Schema extends z.ZodType<any>>(
  formData: z.infer<Schema>,
  actionResult: ErrorActionResultWithoutFormData,
) {
  return {
    ...actionResult,
    formData, // pass down the data to leave the form filled
...
): actionResult is InvalidActionResultWithoutFormData<Schema> => {
  return (
...
export const isErrorActionResult = (
  actionResult: unknown,
): actionResult is ErrorActionResultWithoutFormData => {
  return (
    typeof actionResult === 'object' &&
    actionResult !== null &&
    'success' in actionResult &&
